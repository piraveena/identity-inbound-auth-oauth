...
public class SQLQueries {
    ...
    public static class OAuthAppDAOSQLQueries {
        ...
        public static final String GET_APP_INFO = "SELECT CONSUMER_SECRET, USERNAME, APP_NAME, OAUTH_VERSION, " +
                ...
                "CALLBACK_URL,  BACKCHANNELLOGOUT_URL,TENANT_ID, USER_DOMAIN, GRANT_TYPES, ID, USER_ACCESS_TOKEN_EXPIRE_TIME," +
                " APP_ACCESS_TOKEN_EXPIRE_TIME, REFRESH_TOKEN_EXPIRE_TIME FROM IDN_OAUTH_CONSUMER_APPS" +
                " WHERE CONSUMER_KEY=? ";

        public static final String GET_APP_INFO_WITH_PKCE =
                "SELECT CONSUMER_SECRET,USERNAME,APP_NAME, OAUTH_VERSION, " +
                        "CALLBACK_URL, BACKCHANNELLOGOUT_URL, TENANT_ID, USER_DOMAIN, GRANT_TYPES, ID, " +
                        "PKCE_MANDATORY, PKCE_SUPPORT_PLAIN, " +
                        "USER_ACCESS_TOKEN_EXPIRE_TIME, APP_ACCESS_TOKEN_EXPIRE_TIME, REFRESH_TOKEN_EXPIRE_TIME FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY=? ";

        public static final String GET_APP_INFO_BY_APP_NAME = "SELECT CONSUMER_SECRET, USERNAME, USER_DOMAIN, CONSUMER_KEY, " +
                "OAUTH_VERSION, CALLBACK_URL, BACKCHANNELLOGOUT_URL, GRANT_TYPES, ID, " +
                "USER_ACCESS_TOKEN_EXPIRE_TIME, APP_ACCESS_TOKEN_EXPIRE_TIME,REFRESH_TOKEN_EXPIRE_TIME FROM IDN_OAUTH_CONSUMER_APPS" +
        ...
        public static final String GET_APP_INFO_BY_APP_NAME_WITH_PKCE = "SELECT CONSUMER_SECRET,USERNAME,USER_DOMAIN,CONSUMER_KEY, " +
                "OAUTH_VERSION, CALLBACK_URL, BACKCHANNELLOGOUT_URL, GRANT_TYPES, ID, PKCE_MANDATORY, " +
                "PKCE_SUPPORT_PLAIN, " +
        ...
        public static final String UPDATE_CONSUMER_APP = "UPDATE IDN_OAUTH_CONSUMER_APPS SET APP_NAME=?," +
                " CALLBACK_URL=?,  GRANT_TYPES=?, BACKCHANNELLOGOUT_URL=? , USER_ACCESS_TOKEN_EXPIRE_TIME=?, " +
        ...
        public static final String UPDATE_CONSUMER_APP_WITH_PKCE = "UPDATE IDN_OAUTH_CONSUMER_APPS SET APP_NAME=?," +
                " CALLBACK_URL=?, GRANT_TYPES=?, BACKCHANNELLOGOUT_URL=? , PKCE_MANDATORY=?, PKCE_SUPPORT_PLAIN=?, " +
